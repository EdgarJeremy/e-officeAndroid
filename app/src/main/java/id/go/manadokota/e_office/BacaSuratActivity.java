...
public class BacaSuratActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baca_surat);
        ...
        Config.session_start(BacaSuratActivity.this);

        if(!Prefs.getBoolean("loggedIn",true)) {
            startActivity(new Intent(BacaSuratActivity.this,LoginActivity.class));
            finish();
        } else {
        ...
        btnDisposisi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BacaSuratActivity.this,BuatDisposisiActivity.class);
    ...
    private void populate(String id_pesan) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(BacaSuratActivity.this);
        ...
        Ion.with(BacaSuratActivity.this)
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        if(e != null) {
                            ...
                            Toast.makeText(BacaSuratActivity.this,"Kesalahan saat menghubungi server",Toast.LENGTH_LONG).show();
                        } else {
