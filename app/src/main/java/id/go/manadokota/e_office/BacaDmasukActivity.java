...
public class BacaDmasukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baca_dmasuk);
        ...
        Config.session_start(BacaDmasukActivity.this);

        if(!Prefs.getBoolean("loggedIn",true)) {
            startActivity(new Intent(BacaDmasukActivity.this,LoginActivity.class));
            finish();
        } else {
        ...
        btnStarred = (ToggleImageButton)findViewById(R.id.btnStarred);
    ...
    private void populate(final String id_disposisi) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(BacaDmasukActivity.this);
        ...
        Ion.with(BacaDmasukActivity.this)
                .load(Config.API_BASE_URL + "/ambil_satu_disposisi_masuk")
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, final JsonObject result) {
                        ...
                        if(e != null) {
                            ...
                            Toast.makeText(BacaDmasukActivity.this,"Kesalahan saat menghubungi server",Toast.LENGTH_LONG).show();
                        } else {
                            Log.d(getPackageName(),result.toString());


                            final JsonObject penerima = result.get("penerima").getAsJsonObject();

                            btnStarred.setChecked(penerima.get("starred").getAsInt() != 0);
                            ...
                            btnStarred.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Ion.with(BacaDmasukActivity.this)
                                            ...
                                            .setBodyParameter("id_relasi_disposisi",penerima.get("id_relasi_disposisi").getAsString())
                                            .setBodyParameter("starred",(btnStarred.isChecked()) ? "1" : "0")
                                            .asString()
                                            .setCallback(new FutureCallback<String>() {
                                                ...
                                                public void onCompleted(Exception e, String result) {
                                                    if(e != null) {
                                                        Log.d(getPackageName(),e.getMessage());
                                                        btnStarred.setChecked(!btnStarred.isChecked());
                                                        Toast.makeText(BacaDmasukActivity.this,"Terjadi kesalahan!",Toast.LENGTH_LONG).show();
                                                    } else {
                                                        Log.d(getPackageName(),result);
                                                        Toast.makeText(BacaDmasukActivity.this,"Disposisi diupdate",Toast.LENGTH_LONG).show();
                                                    }
                                                }
                                            });
                                }
                            ...
                            txNamaPengirim.setText(penerima.get("pengirim").getAsString());
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(isi_follow_up.equals("")) {
                                        ...
                                        Ion.with(BacaDmasukActivity.this)
                                                ...
                                                .setBodyParameter("id_disposisi",result.get("id_disposisi").getAsString())
                                                .setBodyParameter("kode_disposisi",penerima.get("kode_disposisi").getAsString())
                                                .setBodyParameter("id_pengguna",pengguna.get("id_pengguna").toString())
                                                .setBodyParameter("pembuat",penerima.get("dari_user").getAsString())
                                                ...
                                                .setCallback(new FutureCallback<String>() {
                                                    ...
                                                    public void onCompleted(Exception e, String result) {
                                                        ...
                                                        if(result.equals("true")) {
                                                            etFollowUp.setText("");
                                                            populate(id_disposisi);
                                                            Toast.makeText(BacaDmasukActivity.this,"Follow up berhasil terkirim",Toast.LENGTH_LONG).show();
                                                        } else {
                                                            Toast.makeText(BacaDmasukActivity.this,"Terjadi kesalahan pada server",Toast.LENGTH_LONG).show();
                                                        }
                                                        progressDialog.dismiss();
                                                    }
                                                });
